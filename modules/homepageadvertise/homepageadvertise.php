...
class HomepageAdvertise extends Module {
	...
	public function install()
	{
		...
		if (!parent::install() OR !$this->registerHook('home') OR !$this -> registerHook('maxSlideshow') OR !$this->registerHook('header'))
			return false;
	...
	public function getContent() {
		...
		<option ' . ((Configuration::get($this->name.'_hook') == 2) ? 'selected="selected" ' : '') . 'value="2">Full width(top of page)</option>
