	...
	public function initContent()
  	{
	    ...
	    else
	    {
	    	...
	    	$meta_description = Configuration::get('PH_BLOG_MAIN_DESCRIPTION', Context::getContext()->language->id) ? Configuration::get('PH_BLOG_MAIN_DESCRIPTION', Context::getContext()->language->id) : '';
