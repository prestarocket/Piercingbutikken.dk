...
class TextBanners extends Module {
	...
	public function install() {
		/* Adds Module */
		if (parent::install() && $this->registerHook('maxInfos') && $this->registerHook('home') && $this->registerHook('maxInfos2') && $this->registerHook('header') && $this->registerHook('actionShopDataDuplication')) {
